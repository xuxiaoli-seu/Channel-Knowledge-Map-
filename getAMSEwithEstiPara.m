...
function [AMSE_knownPara,AMSE_simu1,AMSE_lowBeta]=getAMSEwithEstiPara(RegionCenter,d,k_vec,numSamples_lb)
...
%numSamples_lb=20; % the minimum number of samples in the CGM
...
MeasureLoc=getMeasureLoc_PPP_GivenCenter(D,numSamples_lb,RegionCenter);
%size(MeasureLoc)
...
%==============Analysis when beta is small==============
AMSE_lowBeta=(1+2/numSamples)*(alpha+sigma_sq);
%=============================================================
...
[alpha_est1, beta_est1,~]=EstShadowPara_LS(YQ_shaFad,distanceMatrixSample);
